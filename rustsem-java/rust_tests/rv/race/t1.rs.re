<generatedTop>
  <threads>
    <Thread>
      ...
      <clstack>
        ...
        var ( 9 ) |-> #sl ( 2 ) )
        ListItem ( var ( 3 ) )
        ListItem ( #state ( #freezer#letcl1_ ( var ( 10 ) , callcl ( #cpath ( #owner ( #IdTy ( JoinHandle , #prod ( #fd ( handle , i32 ) , .Fields ) ) ) , join ) , refcl ( 0 , var ( 10 ) ) , .ExpCLs ) ;cl clskip ;cl letcl var ( 11 ) =cl var ( 5 ) incl clskip ) ~> #freezer#computeFB0_ ( ) ~> #freezer#computeFB0_ ( ) ~> #freezer#computeFB0_ ( ) ~> #freezer#computeFB0_ ( ) , var ( 5 ) |-> #sl ( 0 )
        var ( 6 ) |-> #sl ( 1 )
        var ( 9 ) |-> #sl ( 2 ) ) )
        ListItem ( var ( 9 ) )
        ListItem ( var ( 5 ) |-> #sl ( 0 )
  ...
  <memory>
    ...
    <blocks>
      ...
      #heap ( 2 , 1 ) |-> cr ( 5 )
      #heap ( 3 , 0 ) |-> valcl ( "" )
      #heap ( 4 , 0 ) |-> #shr ( 12 , 19 , #sl ( 4 ) )
      0 |-> #blkInfo ( 1 , #IdTy ( ARC , #prod ( #fd ( p , #raw ( #owner ( #IdTy ( P , #prod ( #fd ( x , i32 ) , .Fields ) ) ) ) ) , .Fields ) ) )
      1 |-> #blkInfo ( 1 , #IdTy ( #env ( 0 ) , #prod ( #fd ( r , #owner ( #IdTy ( ARC , #prod ( #fd ( p , #raw ( #owner ( #IdTy ( P , #prod ( #fd ( x , i32 ) , .Fields ) ) ) ) ) , .Fields ) ) ) ) , .Fields ) ) )
      2 |-> #blkInfo ( 2 , #owner ( #closureTy ( #envId ( 0 ) , fnTy ( .CoreTys ) -> #void ) ) )
      3 |-> #blkInfo ( 1 , #owner ( str ) )
      4 |-> #blkInfo ( 1 , #IdTy ( Builder , #prod ( #fd ( name , #ref ( #owner ( str ) ) ) , .Fields ) ) )
    </blocks>
    <locRW>
      ...
      SetItem ( #lread ( #sl ( 6 ) . valcl ( 0 ) , 19 ) )
      SetItem ( #lwrite ( #sl ( 1 ) , 4 ) )
      SetItem ( #lwrite ( #sl ( 5 ) , 15 ) )
    </locRW>
    <memStatus>
      #heap ( 0 , 0 ) |-> #ms ( 0 , 0 )
      #heap ( 1 , 0 ) |-> #ms ( 0 , 0 )
