  ...
  <threads>
    <Thread>
      ...
      <clstack>
        ...
        var ( 9 ) |-> #sl ( 2 ) )
        ListItem ( var ( 3 ) )
        ListItem ( #state ( #freezer#letcl1_ ( var ( 10 ) , letcl var ( 11 ) =cl var ( 5 ) incl ( callcl ( #cpath ( #owner ( #IdTy ( JoinHandle , #prod ( #fd ( handle , i32 ) , .Fields ) ) ) , join ) , refcl ( 0 , var ( 10 ) ) , .ExpCLs ) ;cl clskip ) ) ~> #freezer#computeFB0_ ( ) ~> #freezer#computeFB0_ ( ) ~> #freezer#computeFB0_ ( ) ~> #freezer#computeFB0_ ( ) , var ( 5 ) |-> #sl ( 0 )
        var ( 6 ) |-> #sl ( 1 )
        var ( 9 ) |-> #sl ( 2 ) ) )
        ListItem ( var ( 9 ) )
        ListItem ( var ( 5 ) |-> #sl ( 0 )
