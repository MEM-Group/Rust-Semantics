<generatedTop>
  ...
  <memory>
    ...
    <locRW>
      ...
      SetItem ( #lread ( #sl ( 7 ) . valcl ( 0 ) , 21 ) )
      SetItem ( #lwrite ( #sl ( 1 ) , 6 ) )
      SetItem ( #lwrite ( #sl ( 6 ) , 17 ) )
    </locRW>
    <memStatus>
      #heap ( 0 , 0 ) |-> #ms ( 0 , 0 )
      #heap ( 1 , 0 ) |-> #ms ( 0 , 0 )
  ...
  <TCContext>
    <varCtx>
      ...
      <vInfo>
        ...
        var ( 15 ) |-> varInfo ( handle , #owner ( #IdTy ( JoinHandle , #prod ( #fd ( handle , i32 ) , .Fields ) ) ) , 1 )
        var ( 16 ) |-> varInfo ( z , i32 , 1 )
      </vInfo>
    </varCtx>
    <typeCtx>
