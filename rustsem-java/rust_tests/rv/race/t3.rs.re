<generatedTop>
  <threads>
    <Thread>
      ...
      <clstack>
        ...
        var ( 9 ) |-> #sl ( 2 ) )
        ListItem ( var ( 3 ) )
        ListItem ( #state ( #freezer#letcl1_ ( var ( 10 ) , callcl ( #cpath ( #owner ( #IdTy ( JoinHandle , #prod ( #fd ( handle , i32 ) , .Fields ) ) ) , join ) , refcl ( 0 , var ( 10 ) ) , .ExpCLs ) ;cl clskip ;cl letcl var ( 11 ) =cl #move ( var ( 5 ) ) incl clskip ) ~> #freezer#computeFB0_ ( ) ~> #freezer#computeFB0_ ( ) ~> #freezer#computeFB0_ ( ) ~> #freezer#computeFB0_ ( ) , var ( 5 ) |-> #sl ( 0 )
        var ( 6 ) |-> #sl ( 1 )
        var ( 9 ) |-> #sl ( 2 ) ) )
        ListItem ( var ( 9 ) )
        ListItem ( var ( 5 ) |-> #sl ( 0 )
  ...
  <memory>
    ...
    <locRW>
      ...
      SetItem ( #lread ( #sl ( 3 ) , 18 ) )
      SetItem ( #lread ( #sl ( 5 ) , 16 ) )
      SetItem ( #lread ( #sl ( 6 ) . valcl ( 0 ) , 21 ) )
  ...
  <TCContext>
    <varCtx>
      ...
      <vInfo>
        ...
        var ( 5 ) |-> varInfo ( v , #owner ( #array ( i32 , 2 ) ) , 1 )
        ...
        var ( 11 ) |-> varInfo ( z , #owner ( #array ( i32 , 2 ) ) , 1 )
      </vInfo>
    </varCtx>
    <typeCtx>
